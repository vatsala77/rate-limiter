...
import type { UpdateDestinationInput, UpdateDestinationOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateDestinationCommand_base: {
    new (input: UpdateDestinationCommandInput): import("@smithy/core/client").CommandImpl<UpdateDestinationCommandInput, UpdateDestinationCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDestinationCommandInput): import("@smithy/core/client").CommandImpl<UpdateDestinationCommandInput, UpdateDestinationCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
