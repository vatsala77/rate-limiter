...
declare const CreateDeliveryStreamCommand_base: {
    new (input: CreateDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<CreateDeliveryStreamCommandInput, CreateDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<CreateDeliveryStreamCommandInput, CreateDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
