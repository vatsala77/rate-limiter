...
declare const StartDeliveryStreamEncryptionCommand_base: {
    new (input: StartDeliveryStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StartDeliveryStreamEncryptionCommandInput, StartDeliveryStreamEncryptionCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartDeliveryStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StartDeliveryStreamEncryptionCommandInput, StartDeliveryStreamEncryptionCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
