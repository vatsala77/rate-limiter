...
declare const StopDeliveryStreamEncryptionCommand_base: {
    new (input: StopDeliveryStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StopDeliveryStreamEncryptionCommandInput, StopDeliveryStreamEncryptionCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopDeliveryStreamEncryptionCommandInput): import("@smithy/core/client").CommandImpl<StopDeliveryStreamEncryptionCommandInput, StopDeliveryStreamEncryptionCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
