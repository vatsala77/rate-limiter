...
import type { PutRecordBatchInput, PutRecordBatchOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const PutRecordBatchCommand_base: {
    new (input: PutRecordBatchCommandInput): import("@smithy/core/client").CommandImpl<PutRecordBatchCommandInput, PutRecordBatchCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRecordBatchCommandInput): import("@smithy/core/client").CommandImpl<PutRecordBatchCommandInput, PutRecordBatchCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
