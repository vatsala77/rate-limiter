...
declare const TagDeliveryStreamCommand_base: {
    new (input: TagDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<TagDeliveryStreamCommandInput, TagDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<TagDeliveryStreamCommandInput, TagDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
