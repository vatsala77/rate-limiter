...
declare const UntagDeliveryStreamCommand_base: {
    new (input: UntagDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<UntagDeliveryStreamCommandInput, UntagDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<UntagDeliveryStreamCommandInput, UntagDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
