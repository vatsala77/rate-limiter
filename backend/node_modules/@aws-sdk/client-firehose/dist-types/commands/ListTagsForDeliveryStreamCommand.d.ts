...
declare const ListTagsForDeliveryStreamCommand_base: {
    new (input: ListTagsForDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<ListTagsForDeliveryStreamCommandInput, ListTagsForDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTagsForDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<ListTagsForDeliveryStreamCommandInput, ListTagsForDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
