...
import type { DescribeDeliveryStreamInput, DescribeDeliveryStreamOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeDeliveryStreamCommand_base: {
    new (input: DescribeDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeliveryStreamCommandInput, DescribeDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<DescribeDeliveryStreamCommandInput, DescribeDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
