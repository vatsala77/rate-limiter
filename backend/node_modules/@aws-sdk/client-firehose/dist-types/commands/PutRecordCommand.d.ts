...
declare const PutRecordCommand_base: {
    new (input: PutRecordCommandInput): import("@smithy/core/client").CommandImpl<PutRecordCommandInput, PutRecordCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRecordCommandInput): import("@smithy/core/client").CommandImpl<PutRecordCommandInput, PutRecordCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
