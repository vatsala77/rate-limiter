...
import type { ListDeliveryStreamsInput, ListDeliveryStreamsOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const ListDeliveryStreamsCommand_base: {
    new (input: ListDeliveryStreamsCommandInput): import("@smithy/core/client").CommandImpl<ListDeliveryStreamsCommandInput, ListDeliveryStreamsCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDeliveryStreamsCommandInput]): import("@smithy/core/client").CommandImpl<ListDeliveryStreamsCommandInput, ListDeliveryStreamsCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
