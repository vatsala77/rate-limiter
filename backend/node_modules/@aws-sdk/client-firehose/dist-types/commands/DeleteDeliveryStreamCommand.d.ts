...
import type { DeleteDeliveryStreamInput, DeleteDeliveryStreamOutput } from "../models/models_0";
/**
 * @public
 */
...
declare const DeleteDeliveryStreamCommand_base: {
    new (input: DeleteDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliveryStreamCommandInput, DeleteDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDeliveryStreamCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeliveryStreamCommandInput, DeleteDeliveryStreamCommandOutput, import("..").FirehoseClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
